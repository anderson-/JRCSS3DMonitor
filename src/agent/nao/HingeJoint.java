...
import agent.effectors.HingeJointEffector;
import agent.perceptors.HingeJointPerceptor;
 ...
 * @author anderson
 */
public class HingeJoint extends Node<HingeJoint>{
    ...
    private HingeJointPerceptor perceptor;
    private HingeJointEffector effector;
    
    public HingeJoint (String fullName, String name){
        super(fullName);
    }
